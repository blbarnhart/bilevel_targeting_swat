...
getObjs <- function(input_taxes) {
	
	input_taxes_tills = c(input_taxes,rep(0.1,112))
	#print(input_taxes_tills)
	#example input
	...
	setwd("/home/blb/swat/bilevel_targeting_swat/Raccoon/")
	source('/home/blb/swat/bilevel_targeting_swat/Raccoon/rcode_taxonly/taxonly_sub_optim.R')

	lookupfile = read.csv('/home/blb/swat/bilevel_targeting_swat/Raccoon/rcode_taxonly/lookup_qfix.csv')
...
#        nohru = 193
        ...
        stringMin = replicate(nobsn,var_limits[1,1])
        stringMax = replicate(nobsn,var_limits[1,2])
