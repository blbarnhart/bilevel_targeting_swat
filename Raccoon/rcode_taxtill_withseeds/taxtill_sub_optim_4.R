...
#BLB 2018-09-13 NOTE THAT TILLONLY SRC FOLDER IS THE SAME AS TAXTILL. THE ONLY
#DIFFERENCE IS THAT IN THE TILLONLY CASE, ALL OF THE FERT MULTIPLIERS ARE 1. 
#SO, JUST USE TILLONLY FOR THE TIME BEING. 
