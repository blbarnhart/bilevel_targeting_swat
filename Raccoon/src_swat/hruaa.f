...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      do j = 1, nhru
        ...
        if (idum > 0) then
          ...
          write (28,1000) cropname, j, hrugis(j), sb,                   &
     ...
     &    nmgt(j), years, hru_km(j), (pdvas(ii), ii = 1, mhruo), iyr
      ...
      return
 1000 format (a4,i4,1x,i8,1x,i4,1x,i4,1x,f4.1,e10.5,66f10.3,1x,
     *e10.5,1x,e10.5,2e10.3,1x,i4)
!2000 format (a4,i5,1x,i8,1x,i4,1x,i4,1x,f4.1,e10.5,70f10.3,1x,i4)
      end
