...
!! septic change added iseptic 1/28/09 gsm
      integer, dimension (:), allocatable :: isep_typ, ipop_sep
      real :: bio_rt, mrt_rt, plq_rt, rsp_rt, slg_rt, vp     
      real, dimension (:), allocatable :: sptqs
      real, dimension (:), allocatable :: sptbodins, spttssconcs
      ...
      real, dimension (:), allocatable :: sptfcolis                
!! septic changes added 1/28/09 gsm
      integer, dimension (:), allocatable :: i_sep 
      real, dimension (:), allocatable :: bio_amn, bio_bod, biom
	real, dimension (:), allocatable :: bio_fecal, bio_ntr, bz_perc
	real, dimension (:), allocatable :: plqm 
      real, dimension (:), allocatable :: bz_z, bz_thk, bz_area, bio_bd
...
!! septic changes added 1/28/09 gsm
      integer, dimension (:), allocatable :: idspts
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!..R ... PGA variables... number of parameters = 5*533+2*381+2 = 3429
!
! variable selection from table 1 - Regional estimation ... UMRB, Kannan
      integer, parameter :: numsub = 112  !! from output.std
      integer, parameter :: nohru = 3640   !! from output.std
      integer, parameter :: numobs = 731 !! number of observations in time series

!               double precision :: phu_pga(nohru)
!               double precision :: solk_pga(nohru)
!               double precision :: awhc_pga(nohru)
!               double precision :: solcrk_pga(nohru)
!               double precision :: chn2_pga(numsub)
!               double precision :: ovn_pga(nohru)
!               double precision :: canmx_pga(nohru)
!               double precision :: esco_pga(nohru)
!               double precision :: epco_pga(nohru)
!               double precision :: revapmn_pga(nohru)
!               double precision :: alpha_bf_pga(nohru)
!               double precision :: gwdelay_pga(nohru)
!               double precision :: gw_revap_pga(nohru)
!               double precision :: surlag_pga
!               double precision :: msk_co1_pga
!               double precision :: msk_co2_pga
!               double precision :: msk_x_pga
!               double precision :: trnsrch_pga
!               double precision :: evrch_pga
!               double precision :: slsubbsn_pga(nohru)
!               double precision :: slsoil_pga(nohru)
!               double precision :: hruslp_pga(nohru)
!               double precision :: timp_pga
!               double precision :: smfmn_pga
!               double precision :: smfmx_pga
!               double precision :: chl1_pga(numsub)
!               double precision :: chs1_pga(numsub)
!               double precision :: chw1_pga(numsub)
!               double precision :: chn1_pga(numsub)
!               double precision :: chk1_pga(numsub)
!               double precision :: chl2_pga(numsub)
!               double precision :: chs2_pga(numsub)
!               double precision :: chw2_pga(numsub)
!               double precision :: chd_pga(numsub)
!               double precision :: chk2_pga(numsub)
!               double precision :: chwdr_pga(numsub)
!               double precision :: alpha_bnk_pga(numsub)
!               double precision :: gwqmn_pga(nohru)
!               double precision :: rchrgdp_pga(nohru)
!               double precision :: gwspyld_pga(nohru)
               
            !!!!! link from GAMS to fertilizer application   
               double precision :: frt_kg_pga(nohru)
               double precision :: tillchoice_pga(nohru)
            !!!!! output to R, flow, variables for Malmquist index (rtout.f)   
               double precision, dimension(1,numobs) :: rchdy2_pga   !!rchdy(2,:)   |m^3/s  |flow out of reach on day, set in reachout.f, 341
      end module parm
