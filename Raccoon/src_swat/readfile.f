...
!       itoth = mhruo
      ...
      open (124, file="output.mgt", recl=600)
      open (28,file="output.hru",recl=800)
...
!     end do 
	...
	!! sj june 07 / nancy Jan 09 output carbon routines 
      open (98,file="cswat_daily.txt",recl=260)
     ...
     &'sum_n_i',';','sum_n_f',';','bal_p',';','sum_p_i',';','sum_p_f'	
      ...
      open (100,file="cswat_profile.txt",recl=150)
      write (100,*) 'year',';','day',';','hru',';','cmass',';','nmass',
     &';','sol_rsd',';','sol_cdec',';','rdc',';','sol_no3',
     &';','sol_orgp',';','sol_fop',';','sol_solp',';','mancmass',
     &';','mannmass',';','manpmass'
