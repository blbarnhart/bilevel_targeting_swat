...
inputs = read.csv('/home/blb/swat/swat_sweden/results/taxtill/taxtill_gen100.csv')
for (i in 1:60) {
...
write.csv(out4,'addhru/taxtill_basin_targeting_nonNAoutputs.csv',quote=F,row.names=F)
